...
<div
	class="w-full bg-gradient-to-br from-background to-surface items-center flex flex-row h-screen"
>
	<div
	...
	>
		...
		<SubTitle class="hidden lg:block">Type your username...</SubTitle>
		<AuthForm />
	</div>
</div>
